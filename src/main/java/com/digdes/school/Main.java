...
public class  Main {
    public static void main(String[] args) throws Exception {
        List<String> conditions = Arrays.stream("'active'=false ,'cost' = 10.1, 'age'ilike   53 ,  'active'=false".split("[ ]"))
                .filter(s -> !s.isEmpty())
...
//          parser.parseRequest("INSERT VALUES 'lastName' = 'Федоров',  'id'=3, 'age'=40, 'active'=true");
